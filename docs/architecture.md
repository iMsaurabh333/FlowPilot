...
- [MCP server onboarding](./mcp-server-onboarding.md) is the required approval and release procedure for any new server, connector boundary, or material tool-set change.
